...
describe('PlayPauseButtonPlugin', function() {
  ...
  describe('layer getter', () => {
    ...
    test('is configurable via mediaControl.playPauseComponent.layer config', () => {
      const { plugin } = setupTest({ mediaControl: { playPauseComponent: { layer: 2 } } })
  ...
  describe('section getter', () => {
    ...
    test('is configurable via mediaControl.playPauseComponent.section config', () => {
      const { plugin } = setupTest({ mediaControl: { playPauseComponent: { section: 2 } } })
  ...
  describe('position getter', () => {
    ...
    test('is configurable via mediaControl.playPauseComponent.position config', () => {
      const { plugin } = setupTest({ mediaControl: { playPauseComponent: { position: 3 } } })
  ...
  describe('separator getter', () => {
    test('is configurable via mediaControl.playPauseComponent.separator config', () => {
      const { plugin } = setupTest({ mediaControl: { playPauseComponent: { separator: true } } })
